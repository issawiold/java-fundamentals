...
public class Theater extends Business implements AddReview<Theater> {
    ...
    public String toString() {
        return super.toString()+"Movies: "+this.movies;
    }
    ...
    @Override
    public void addReview(String body, String author, double stars,Theater T) {
